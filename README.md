...
║     Open to: SDE  ·  Android  ·  ML Engineer roles               ║
╚══════════════════════════════════════════════════════════════════╝
```
...
```yaml
name:         Farhan Khalid
title:        Trainee Software Engineer | Android Developer | AI/ML Backend Engineer
...
core_skills:
  languages:  [Java, Python, JavaScript, Dart, C++, SQL]
  mobile:     [Android (Java), Flutter (Dart)]
  ai_ml:      [TensorFlow Lite, OpenCV, MediaPipe, Machine Learning]
  backend:    [Node.js, Express.js, Firebase, REST APIs, MongoDB]
  frontend:   [React.js, HTML5, CSS3]
  tools:      [Git, GitHub Copilot, JUnit, Espresso, Agile]

leetcode:     "150+ problems solved"
hackathon:    "Smart India Hackathon 2024 — 500+ national teams"
seeking:      "Full-time SDE / Android / ML roles — Delhi · Noida · Gurugram"
...
> Issued by SAP · **Valid: May 2026 – May 2027** · Validates OO ABAP, RAP, OData, CDS Views, Clean Core, SAP BTP
...
Built an AI-powered accessibility tool using computer vision during a national-level sprint, competing among **500+ teams** across India.

</td>
<td width="50%" valign="top">

### 💻 LeetCode — 150+ Problems Solved
Sharpened analytical and problem-solving skills by solving **150+ data structure and algorithm problems**, spanning arrays, trees, graphs, and dynamic programming.
...
### 📱 Google Play Store — Live Publisher
Independently designed, built, and published a production-grade Android application to the **Google Play Store**, handling the full release lifecycle end-to-end.

</td>
<td width="50%" valign="top">

### 🎓 Academic Excellence
Maintaining a strong **8.21 / 10 CGPA** in B.Tech — Artificial Intelligence & Data Science while actively building and shipping real-world software.
...
|--------|-------------|-------|------|
| B.Tech — Artificial Intelligence & Data Science | Galgotias College of Engineering & Technology, AKTU | **8.21 CGPA** | 2026 |
